...
class SPM_ShopyMind_Action_GenerateVoucher implements SPM_ShopyMind_Interface_Action
{
    ...
    public function __construct($id_customer, $type, $amount, $amountCurrency, $minimumOrder, $nbDayValidate, $description, $prefix = null, $duplicateCode = null)
    {
