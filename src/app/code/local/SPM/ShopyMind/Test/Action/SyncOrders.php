...
class SPM_ShopyMind_Test_Action_SyncOrders extends PHPUnit_Framework_TestCase
{
    ...
    {
        $actual = $this->actualOrdersIdsFromSyncOrders('', null, null, null);
    ...
    {
        $actual = $this->actualOrdersIdsFromSyncOrders('website-2', null, null, null);
        $expected = array(1);
    ...
    {
        $actual = $this->actualOrdersIdsFromSyncOrders('', 1, 2, null);
        $expected = array(2, 3);
    ...
    {
        $actual = $this->actualOrdersIdsFromSyncOrders('', null, null, '2015-12-09 00:00:00');
        $expected = array(3);
    ...
    {
        $actual = $this->actualOrdersIdsFromSyncOrders('', null, null, null, 2);
        $expected = array(2);
    ...
    {
        $actual = $this->actualOrdersIdsFromSyncOrders('', null, null, null, array(2, 3));
        $expected = array(2, 3);
